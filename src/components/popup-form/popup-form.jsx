...
const PopupForm = (props) => {
  ...
  return (
    <section className={`page-popup message-popup ${active ? `active` : ``}`} onClick={() => setActive(false)}>
      <div className="message-popup__container" onClick={(evt) => evt.stopPropagation()}>
        ...
        <button className="message-popup__btn close-btn" type="button" aria-label="Закрыть" onClick={() => setActive(false)}>
        ...
        <form className="message-popup__form message-form" action="https://echo.htmlacademy.ru" method="post" onSubmit={handleSubmit}>
          <div className="message-form__wrapper">
            <div className="message-form__left">
              ...
              <label className="message-form__label">
                <input className="message-form__field" type="text" name="mail-id" placeholder="Достоинства" />
              </label>

              <label className="message-form__label">
                <input className="message-form__field" type="text" name="mail-id" placeholder="Недостатки" />
              </label>
